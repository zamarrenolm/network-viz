...
public class Grid {
    ...
    public List<Line> subNetworks() {
        System.out.println("Computing the subNetworks (not included in the backbone)");
        ...
        List<Line> subNetworksLines = network.getLineStream()
                ...
                .collect(Collectors.toList());
        System.out.println("  SubNetworks lines size     = " + subNetworksLines.size());
